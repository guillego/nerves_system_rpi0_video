defmodule NervesSystemRpi02.MixProject do
  ...
  defp deps do
    [
      #{:nerves, "~> 1.5.4 or ~> 1.6.0 or ~> 1.7.15 or ~> 1.8 or ~> 1.10", runtime: false},
      {:nerves, git: "https://github.com/nerves-project/nerves",
      branch: "893-fix-shell-task",
      override: true},
  ...
  defp description do
    """
    Nerves System - Zero 2 W/3A+ (64-bits) + video support
    """
  end
